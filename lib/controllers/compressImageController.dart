...
class ImageController extends GetxController {
  ...
  void onInit() {
    super.onInit();
    // Clear all images when app starts to ensure no stale selections persist
  ...
  RxList<CompressedImage> getOriginalList() =>
      _imageModel.getOriginalImages().obs;
  //endregion
  ...
  RxList<CompressedImage> getCompressList() =>
      _imageModel.getCompressImages().obs;
  //endregion
